        ...
        <article class="chamber__focal">
            <section class="showcase">
            	...
            	<div class="content doc">
                    ...
                    <h3>Cookies</h3>
                    <p>
                    We employ the use of cookies. By accessing Varsity's Eatery, you agreed to use cookies in agreement with the Company Name's Privacy Policy.
                    </p>
                    <p>
                    ...
                    <h3>License</h3>
                    <p>
                    Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Varsity's Eatery. All intellectual property rights are reserved. You may access this from Varsity's Eatery for your own personal use subjected to restrictions set in these terms and conditions.
                    </p>
                    <p>
                    You must not:
                    </p>
