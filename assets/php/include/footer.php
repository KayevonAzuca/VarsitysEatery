	<footer class="alcove">
    	...
    	<span class="alcove__item">Created by: WTD |</span>
    	<span class="alcove__item">Developer: K. |</span>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDeedAM8P0ormFxWj8jFeyyFni3TyPjF-s&callback=initMap"
